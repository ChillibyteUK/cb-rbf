...
function widgets_init()
{
    ...
    register_sidebar(
        array(
            'name'          => __('Footer Col 1', 'cb-rbf'),
            'id'            => 'footer-1',
            'description'   => __('Footer Col 1', 'cb-rbf'),
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'cb-rbf'),
    ));

    register_nav_menus(array(
        'footer_menu1' => __('Footer Menu 1', 'cb-rbf'),
    ));
    register_nav_menus(array(
        'footer_menu2' => __('Footer Menu 2', 'cb-rbf'),
    ));
    register_nav_menus(array(
        'footer_menu3' => __('Footer Menu 3', 'cb-rbf'),
    ));
